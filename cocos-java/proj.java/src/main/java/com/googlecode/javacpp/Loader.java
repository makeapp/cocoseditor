 ...
 * and a {@link java.util.HashMap} initialized by the native libraries inside {@code JNI_OnLoad()}.
 *
 * @author Samuel Audet
 */
public class Loader
...
//        }
    ...
    /**
     * Loads the {@link java.util.Properties} associated with the default {@link #getPlatform()}.
     *
    ...
    /**
     * Loads from resources the default {@link java.util.Properties} of the specified platform name.
     *
     ...
     * in {@link java.util.Properties}. As a {@link java.util.HashMap}, it makes the result
     ...
     *
     * @see #extractResource(java.net.URL, java.io.File, String, String)
     */
     ...
     *
     * @throws java.io.IOException if fails to extract resource properly
     */
...
//                        command.add(Loader.class.getName());
     ...
     * of {@code struct}, {@code class}, and {@code union}. A {@link java.util.WeakHashMap}
