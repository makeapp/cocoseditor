...
#ifndef  _APP_CCECONTROLLER_H_
#define  _APP_CCECONTROLLER_H_
...
class  CCEController : public cocos2d::Component, public cce::CCEInputDelegate
{
public:
        static CCEController* create();
